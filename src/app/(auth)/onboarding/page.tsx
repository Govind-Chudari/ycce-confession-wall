...
// import { Upload, UserCheck, Shield } from 'lucide-react'
...
//   const handleIdCardUpload = (e: React.ChangeEvent) => {
...
//       if (rooms) {
//         const memberships = rooms.map(room => ({
//           user_id: user.id,
//           room_id: room.id,
//         }))
...
//                       : 'Click to upload ID card (JPG/PNG, max 5MB)'}
...
//                 Your real identity will only be visible to admins for verification
              
              
                
//                 You'll appear anonymous to other users
