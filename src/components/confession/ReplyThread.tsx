...
export const ReplyThread = forwardRef<HTMLDivElement, ReplyProps>(
  ({ reply, currentUserId, onReply, onLike, onDelete, depth = 0 }, ref) => {
      ...
      >
        ...
        {reply.children && reply.children.length > 0 && (
          <div className="space-y-0 relative">
             ...
             {/* ✅ Fixed: Removed mode='popLayout' to prevent ref-extensibility crashes in recursive threads */}
             <AnimatePresence>
